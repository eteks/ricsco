    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('street', models.CharField(default=b'', help_text=b'Actor street full address information', max_length=512, blank=True)),
                ...
                ('city', models.CharField(default=b'', help_text=b'Actor city information', max_length=128, blank=True)),
                ('state', models.CharField(default=b'', help_text=b'Actor state information', max_length=128, blank=True)),
                ...
                ('geotag', models.CharField(default=b'', help_text=b'Geo-tagging help users find a wide variety of location-specific information', max_length=128, blank=True)),
                ...
                ('latitude', models.FloatField(help_text=b'latitude of consumer address', null=True)),
                ('longitude', models.FloatField(help_text=b'longitude of consumer address', null=True)),
                ('geo_address', models.CharField(help_text=b'Modified address to which latitude and longitude is identified', max_length=1024, null=True)),
                ('geo_location_status', models.CharField(default=b'notcalc', max_length=16, null=True, help_text=b'Status of Geo location', choices=[(b'notcalc', b'Not calculated'), (b'wrong_address', b'Wrong Address'), (b'identified', b'Identified')])),
            ],
            options={
        ...
        migrations.CreateModel(
            name='ActorRating',
            fields=[
                ('rating_ptr', models.OneToOneField(parent_link=True, auto_created=True, primary_key=True, serialize=False, to='actors.Rating')),
                ('reviews', models.ForeignKey(blank=True, to='actors.ActorReview', help_text=b'Ranking for the Actor', null=True)),
            ],
            bases=('actors.rating',),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='companyabstract',
            name='created_by',
            field=models.ForeignKey(related_name='company_created', blank=True, to='actors.Actor', help_text=b'Auto generated by system', null=True),
        ),
        migrations.AddField(
            model_name='companyabstract',
            name='ranking',
