"""
Django settings for ricsco project.
...
SECRET_KEY = 'moj9fp)h$#5)63(uzi74+jehb)7tb85%1mcog5k+5y*=_(5a@g'
...
INSTALLED_APPS = (
    ...
    'actors','ranks','reviews','core','ricsco','leads','control','dashboard'
)
